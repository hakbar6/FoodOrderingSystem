...
/***
 Diimplement seadanya, sama seperti order application service implementation.

 Fungsi firing nanti akan kita hapus dan ganti dengan fungsi lain yang lebih baik.
 ***/
...
public class PaymentRequestMessageListenerImpl implements PaymentRequestMessageListener {
    ...
    public void completePayment(PaymentRequest paymentRequest) {
        PaymentEvent paymentEvent = paymentRequestHelper
